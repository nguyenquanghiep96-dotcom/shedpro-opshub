...
content = content.replace(/className="bg-\[#eaecf0\] text-\[#5e6578\] rounded-\[4px\] px-\[16px\] py-\[8px\] font-bold text-\[14px\] opacity-50 cursor-not-allowed"/g, 'className="h-[40px] bg-[#eaecf0] text-[#5e6578] rounded-[4px] px-[16px] font-bold text-[14px] opacity-50 cursor-not-allowed flex items-center justify-center"');
