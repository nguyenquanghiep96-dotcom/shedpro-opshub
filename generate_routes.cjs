...
function SortSection() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[400px]" data-name="Sort Section">
...
function RoutesActionBar() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[10px] relative shrink-0 w-[1920px]">
      <div className="bg-white content-stretch flex flex-col gap-[10px] items-start p-[16px] relative rounded-[10px] shrink-0 w-[1872px]">
        ...
        <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Actions">
          <ButtonsContainer />
          <Tag />
          <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[400px]">
...
function RoutesTableHeader() {
  return (
    <div className="bg-white content-stretch flex items-center relative shrink-0 w-full" data-name="Table Header Row">
...
function RoutesTableItem({ id }: { id: string }) {
  return (
    <div className="bg-white content-stretch flex items-center relative shrink-0 w-full" data-name="Table Entry">
      ...
      <div className="flex flex-[1.5_0_0] flex-row items-center self-stretch">
        <div className="content-stretch flex flex-wrap gap-[6px] items-center px-[10px] py-[12px] relative size-full">
          <div className="bg-[#e2e2e2] px-[6px] py-[2px] rounded-[3px]">
             <span className="font-sans font-normal text-[#5e6578] text-[11px]">Delivery Items</span>
          </div>
          <div className="bg-[#e2e2e2] px-[6px] py-[2px] rounded-[3px]">
             <span className="font-sans font-normal text-[#5e6578] text-[11px]">Repo</span>
          </div>
          <div className="bg-[#e2e2e2] px-[6px] py-[2px] rounded-[3px]">
             <span className="font-sans font-normal text-[#5e6578] text-[11px]">Repair</span>
          </div>
          <div className="bg-[#e2e2e2] px-[6px] py-[2px] rounded-[3px]">
             <span className="font-sans font-normal text-[#5e6578] text-[11px]">Lot Transfer</span>
          </div>
          <div className="bg-[#e2e2e2] px-[6px] py-[2px] rounded-[3px]">
             <span className="font-sans font-normal text-[#5e6578] text-[11px]">+1</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
        <div className="content-stretch flex items-center px-[10px] py-[12px] relative size-full">
          <div className="bg-[#32b6fd] content-stretch flex items-center px-[8px] py-[3px] relative rounded-[3px] shrink-0">
            <p className="font-sans font-semibold text-[11px] text-white whitespace-nowrap">Planned</p>
          </div>
        </div>
      </div>
...
function RoutesTitleSection() {
  return (
    <div className="bg-white content-stretch flex items-center justify-between py-[16px] relative shrink-0 w-full" data-name="Table Header">
      <div className="content-stretch flex gap-[10px] items-center pl-[10px] relative shrink-0 w-[874.5px]">
      ...
      <div className="content-stretch flex gap-[42px] items-center relative shrink-0">
        ...
        <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
          ...
          <div className="content-stretch flex items-center relative shrink-0">
            ...
            <div className="bg-white content-stretch flex gap-[6px] items-center justify-center overflow-clip p-[10px] relative rounded-[4px] shrink-0">
              <div className="overflow-clip relative shrink-0 size-[16px]">
                <div className="absolute bottom-[8.33%] left-1/4 right-1/4 top-[8.33%] rotate-180">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 8">
                    <path d="M11.7611 0L6.66667 4.94673L1.57224 0L0 1.52661L6.66667 8L13.3333 1.52661L11.7611 0Z" fill="var(--fill-0, #5E6578)" />
                  </svg>
                </div>
...
export default function RoutesContainer() {
  return (
    <div className="content-stretch flex flex-col items-center w-full" data-name="Routes Container">
      <RoutesActionBar />
      <div className="bg-white content-stretch flex flex-col items-start px-[12px] relative rounded-[10px] shrink-0 w-[1872px]">
        <RoutesTitleSection />
        <div className="content-stretch flex flex-col gap-px items-start relative shrink-0 w-full" data-name="Routes Table">
          <RoutesTableHeader />
...
`
fs.writeFileSync('src/imports/DeliveriesContract/RoutesContainer.tsx', code);
